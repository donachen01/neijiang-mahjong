"""Generate deterministic Neijiang Mahjong GLB assets with Blender.

Run with:
    blender --background --python tools/3d/generate_neijiang_mahjong_assets.py
...
def generate_table() -> None:
    ...
    for obj in objects:
        obj.select_set(True)
    export_selected(OUTPUT_DIR / "neijiang_table.glb")
