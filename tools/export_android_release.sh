...
zip -q -d "$PRUNED_APK" \
  ...
  'assets/.godot/imported/main_scene_v1_0*' \
  'assets/.godot/imported/table_main_3d_cartoon*' \
  'assets/.godot/imported/table_refined_v17*' \
  'assets/.godot/imported/target_layout_zone*' \
  'assets/.godot/imported/tile_symbols_v1*' \
  'assets/.godot/imported/v17_final_template*' \
  'assets/.godot/imported/tile_face_options*' \
