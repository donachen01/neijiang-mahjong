...
func _export_android() -> void:
	...
	preset.set("permissions/read_external_storage", false)
	preset.set("permissions/write_external_storage", false)
	preset.set("permissions/manage_external_storage", false)
