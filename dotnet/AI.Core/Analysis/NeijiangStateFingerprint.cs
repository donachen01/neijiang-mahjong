...
namespace NeijiangMahjong.AI.Core.Analysis;

public static class NeijiangStateFingerprint
{
    public static string BuildTurnKey(NeijiangStateView state, bool preferCsharp, bool forceLightweight)
    {
