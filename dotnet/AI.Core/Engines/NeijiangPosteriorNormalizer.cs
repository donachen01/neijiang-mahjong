...
public sealed class NeijiangPosteriorNormalizer
{
    public NeijiangPosteriorNormalizationResult Normalize(
        NeijiangStateView state,
        IReadOnlyList<int> activeSeats,
        IReadOnlyDictionary<int, Dictionary<int, double>> seatHoldWeights)
    {
        var wallProbability = new double[18];
        var wallExpectedCount = new double[18];
        ...
        {
            seatHoldProbability[seat] = new double[18];
            seatExpectedCount[seat] = new double[18];
        }
        ...
        return new NeijiangPosteriorNormalizationResult
        {
    ...
    private static double BuildWallWeight(NeijiangStateView state, int tileType, int remainingCount)
    {
