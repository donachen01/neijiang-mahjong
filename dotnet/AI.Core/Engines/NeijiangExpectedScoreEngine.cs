...
public sealed class NeijiangExpectedScoreEngine
{
    public NeijiangExpectedScore EvaluateDiscardCandidate(
        ...
        IReadOnlyList<string> routesAfter)
    {
        ...
        return new NeijiangExpectedScore
        {
            Net = net,
            WinGain = winGain,
    ...
    private static int CountActiveOpponents(NeijiangStateView state)
    {
        var count = 0;
