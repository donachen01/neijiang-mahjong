...
public sealed class NeijiangMctsEngine
{
    ...
    public NeijiangSearchResult EvaluateTopCandidates(
        ...
        int rolloutDepth = 2)
    {
        ...
        return new NeijiangSearchResult
        {
    ...
    private bool ShouldSearch(IReadOnlyList<NeijiangCandidateDetail> candidates)
    {
