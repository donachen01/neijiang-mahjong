...
public sealed class NeijiangRoutePlanEngine
{
    ...
    public NeijiangRoutePlanResult Evaluate(NeijiangStateView state, int[] hand18, int meldCount)
    {
        ...
        return new NeijiangRoutePlanResult
        {
    ...
    private RouteFeatures BuildFeatures(NeijiangStateView state, int[] hand18, int meldCount)
    {
